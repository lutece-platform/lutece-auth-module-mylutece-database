...
INSERT INTO core_file (title, id_physical_file, file_size, mime_type) VALUES ('export_myluteceDB_users_csv.xml', (select id_physical_file from core_physical_file where file_value like '<!-- export_myluteceDB_users_csv.xml -->%' )  ,1861,'application/xml');
...
INSERT INTO core_file (title, id_physical_file, file_size, mime_type) VALUES ('export_myluteceDB_users_xml.xml', (select id_physical_file from core_physical_file where file_value like '<!-- export_myluteceDB_users_xml.xml -->%' ) ,259,'application/xml');
